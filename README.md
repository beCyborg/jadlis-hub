...
Одна ссылка. Отправь её [своему ИИ](#для-твоего-ии), и он поставит тебе всё, чем пользуюсь я сам,
объяснит, что это и зачем, и будет получать обновления.
...
**1 · Рабочее место.** Claude Code с моими настройками: терминал, папка для заметок,
...
**2 · Заметки.** Obsidian с моей конфигурацией. Всё, что ИИ узнаёт и делает,
ложится в заметки, и они остаются твоими.
*Зачем:* память, которая не пропадает вместе с закрытым чатом.

**3 · Голос.** Говоришь вслух, а в поле появляется уже вычищенный текст.
По желанию ИИ читает тебе вслух.
*Зачем:* длинное задание проще сказать, чем набрать.

**4 · Поиск.** ИИ ищет в интернете и читает страницы, считая стоимость каждого запроса.
*Зачем:* ответы из сети, а не из памяти модели.

**5 · Исследование.** Один вопрос, а в ответ отчёт из 14 источников и научных статей,
где каждое утверждение перепроверено.
*Зачем:* принять самое эффективное, реалистичное и проверенное решение.

**6 · Проверка планов.** Три разных ИИ ищут дыры в твоём плане до того,
...
- **Управление твоим браузером.** ИИ работает на сайтах, где ты уже залогинен, без передачи паролей.
- **Управление твоим компьютером.** ИИ кликает и печатает в обычных программах на Mac.
- **Скачать книги.** Любая книга или научная статья находится за минуту.
- **Выжимка из видео и текста.** Час видео или толстый файл превращается в пять выводов и список действий.
- **Новости под тебя.** Каждый день ИИ читает новости и говорит, что из них касается тебя.
- **Свои сотрудники.** Пишешь инструкцию, как для нового работника, и ИИ делает эту
  работу сам. Готового помощника можно упаковать и отдать другому человеку.
...
Скопируй в чат Claude Code целиком:
